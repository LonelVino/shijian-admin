<template>
  <div>
    ...
    <el-dialog v-dialogDrag title="给出建议" :visible.sync="suggestDialogVisible" :fullscreen="isPhone">
      ...
      ></el-input>
      <el-button class="suggest-button" round type="success" @click="submitSuggestion()">
        提交
      </el-button>
      <el-button class="suggest-button" round type="info" @click="suggestDialogVisible = false">
        取消
      </el-button>
    </el-dialog>
  </div>
