<template>
  <div>
        ...
        <el-table-column label="对该队伍的操作" width="230">
          <template slot-scope="scope">
            <div class="button-lists">
              ...
              <el-tooltip class="item" effect="dark" content="推荐至校级答辩" placement="top">
                <el-button
              ...
              <el-tooltip class="item" effect="dark" content="取消校级答辩资格" placement="top">
                <el-button
    ...
    <el-dialog v-dialogDrag title="给出建议" :visible.sync="suggestDialogVisible" :fullscreen="isPhone">
      ...
      ></el-input>
      <el-button round class="suggest-button" type="success" @click="submitSuggestion()">提交</el-button>
      <el-button round class="suggest-button" type="info" @click="suggestDialogVisible = false">取消</el-button>
    </el-dialog>
  </div>
</template>
